...
describe('Test precacheFromManifest()', () => {
  ...
  const serviceWorkersFolder = '/test/browser-tests/precache-from-manifest/serviceworkers';
  ...
  describe('precacheFromManifest() Error Cases', function() {
    ...
    it('should fail to install service worker due to Promise resolving to a javascript object, not an array.', () => {
      return swUtils.activateSW(serviceWorkersFolder + '/error-non-array-promise.js')
      .should.be.rejected;
    });

    it('should throw an error when precaching an array of strings', () => {
      return swUtils.activateSW(serviceWorkersFolder + '/error-array-of-strings.js')
      .should.be.rejected;
    });

    it('should throw an error when precaching a promise that resolves to an array of strings', () => {
      return swUtils.activateSW(serviceWorkersFolder + '/error-promise.js')
      .should.be.rejected;
    });
