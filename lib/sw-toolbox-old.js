...
var validatePrecacheManifestInput = function(manifest) {
...
function precacheFromManifest(manifest) {
  if (!(manifest instanceof Promise)) {
    validatePrecacheManifestInput(manifest);
  }
}
...
module.exports = {
  ...
  uncache: uncache,
  precache: precache,
  precacheFromManifest: precacheFromManifest
};
